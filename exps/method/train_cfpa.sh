...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 -m torch.distributed.launch --master_port=22239 --use_env --nproc_per_node=${NUM_GUPS} ${CURDIR}/execute.py --category ${CATEGORY} \
